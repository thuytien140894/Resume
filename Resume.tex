  ...
  \resumeSubHeadingListStart
    ...
    \resumeExperienceSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem 
          {Led the technical debt effort to modularize the existing team code base for improved dependency management, test coverage, 
          and build performance. Also migrated some legacy feature implementation to a new internal UI component framework.}
        \resumeItem
          {Worked with the iOS principle architects to develop new UI components, and migrate the legacy color system to a more modern one 
...
\section{Programming Skills}
 \resumeSubHeadingListStart
    \resumeSubItem
      {Languages:}{Swift, Objective-C, Java, JavaScript, HTML5, CSS, Haskell, \CPlusPlus, C} 
    \resumeSubItem
