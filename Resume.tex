    ...
    \resumeExperienceSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem
          ...
          Knockout.js, and Bootstrap. Implemented important features including path finding, arcball rotation, transform gizmos, collision
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem
      {Tetris-SwiftUI:}{Tetris game using SwiftUI and Combine.}
    \resumeSubItem
      {GTLC:}{Interpreter for the gradually-typed lambda calculus using the eager coercion calculus, implemented in Haskell.}
    \resumeSubItem
      {Safehouse:}{Online cat-and-mouse game using JavaScript, Google Maps APIs, and Firebase.}
    \resumeSubItem
      {fChess:}{Online chess game using JavaScript and 2D game framework Phaser.}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
 \resumeSubHeadingListStart
    ...
    \resumeSubItem
      {Technologies:}{UIKit, SwiftUI, SwiftPM, Combine, Angular, Three.js, Bootstrap, Firebase}
 \resumeSubHeadingListEnd
